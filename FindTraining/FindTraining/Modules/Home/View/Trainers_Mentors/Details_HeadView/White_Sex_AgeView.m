...
@interface White_Sex_AgeView ()
@property (nonatomic, retain) UILabel *label;
@property (nonatomic, retain) UIImageView *imageView;
@property (nonatomic, retain) UIView *customView;
@end

@implementation White_Sex_AgeView
@synthesize age = _age;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _label.font = kFONT_SIZE_15_BOLD;
...
- (void)setSex:(NSString *)sex {
    if (_sex != sex) {
        ...
        if ([_sex isEqualToString:@"男"]) {
            ...
            _customView.backgroundColor = [UIColor colorWithRed:0.2489 green:0.6996 blue:1.0 alpha:1.0];
            ...
            _label.textColor = [UIColor whiteColor];
            _customView.backgroundColor = [UIColor colorWithRed:0.9986 green:0.3696 blue:0.6676 alpha:1.0];
